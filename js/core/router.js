    ...
    N.router = {
        ...
        renderSidebarProjects: function() {
            ...
            try {
                ...
                container.innerHTML = filtered.map(function(p) {
                    ...
                    return '<div class="sidebar-project-item ' + (isSelected ? 'selected' : '') + '" onclick="Nestopia.router.navigateToProject(\'' + p.id + '\')">' +
                        ...
                        '<div class="proj-info">' +
                            ...
                            '<div class="proj-meta">' + (p.type || 'Unknown') + ' · ' + stageDisplay + '</div>' +
                        '</div>' +
                ...
                console.error('[DBG] renderSidebarProjects() crashed:', e.message, e.stack);
                // 不重新抛出 — 防止 DOMContentLoaded 后续流程中断
            }
        }
    };
